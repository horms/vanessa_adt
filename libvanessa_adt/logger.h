...
#ifndef VANESSA_ADT_LOGGER_FLIM
#define VANESSA_ADT_LOGGER_FLIM
...
#define VANESSA_ADT_LOG_UNSAFE(priority, fmt, args...) \
  vanessa_logger_log(vanessa_adt_logger, priority, fmt, ## args);

#define VANESSA_ADT_LOG(priority, str) \
  vanessa_logger_log(vanessa_adt_logger, priority, "%s", str)

#define VANESSA_ADT_DEBUG_UNSAFE(fmt, args...) \
  vanessa_logger_log(vanessa_adt_logger, LOG_DEBUG, \
    __FUNCTION__ ": " fmt, ## args);

#define VANESSA_ADT_DEBUG(str) \
  vanessa_logger_log(vanessa_adt_logger, LOG_DEBUG, \
    __FUNCTION__ ": %s", str);

#define VANESSA_ADT_DEBUG_ERRNO(s) \
  vanessa_logger_log(vanessa_adt_logger, LOG_DEBUG, "%s: %s: %s", \
